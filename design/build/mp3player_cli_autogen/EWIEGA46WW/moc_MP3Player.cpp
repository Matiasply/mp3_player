...
namespace {
struct qt_meta_tag_ZN9MP3PlayerE_t {};
} // unnamed namespace

template <> constexpr inline auto MP3Player::qt_create_metaobjectdata<qt_meta_tag_ZN9MP3PlayerE_t>()
{
    namespace QMC = QtMocConstants;
    QtMocHelpers::StringRefStorage qt_stringData {
        "MP3Player",
    ...
    return QtMocHelpers::metaObjectData<MP3Player, qt_meta_tag_ZN9MP3PlayerE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject MP3Player::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9MP3PlayerE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9MP3PlayerE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN9MP3PlayerE_t>.metaTypes,
    nullptr
} };
...
void MP3Player::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->trackChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (MP3Player::*)()>(_a, &MP3Player::metaDataChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (MP3Player::*)(int )>(_a, &MP3Player::trackChanged, 1))
            return;
    }
}
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9MP3PlayerE_t>.strings))
        return static_cast<void*>(this);
...
// SIGNAL 0
void MP3Player::metaDataChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MP3Player::trackChanged(int _t1)
{
